...
import BookAppSingleCard from "./BookAppSingleCard";
import FeaturesCardSkeletonLoader from "./features/FeaturesCardSkeletonLoader";

const BookAppCarousel = () => {
...
export default BookAppCarousel;
